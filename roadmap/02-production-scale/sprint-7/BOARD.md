...
| PS7.7 | Multi-cloud burst ADR (BL-004, PS7b) | Done | [PS7.7](PS7.7-multicloud-burst-adr.md) — ADR 0010 + simulation + audit |
| PS7.8 | Platform ops triage agent MVP (BL-005, PS7b) | Done | [PS7.8](PS7.8-platform-ops-triage-agent.md) — read-only CLI + runbook §9 |
