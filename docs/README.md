# SpaceOps Mission Agent Lab — Docs & diagrams
...
| **[runbooks/](runbooks/)** | Operator & maintainer runbooks | How to add a new MCP, how to add eval cases, how to operate the agent, future playbooks. |
